...
func TestDeserializeGameWonEvent(t *testing.T) {
	spec := GAME_WON_EVENT
	data := []byte{
		0, 0, 0, 0, // Placeholder for user ID
		0, 0, 11, 188, // Event ID (3004 for GameWon)
	}
	expected := &AsteroidsGameWonMessageDTO{}
...
func TestDeserializeGameLostEvent(t *testing.T) {
	spec := GAME_LOST_EVENT
	data := []byte{
		0, 0, 0, 0, // Placeholder for user ID
		0, 0, 11, 189, // Event ID (3005 for GameLost)
	}
	expected := &AsteroidsGameLostMessageDTO{}
...
func TestDeserializeUntimelyAbortEvent(t *testing.T) {
	spec := UNTIMELY_ABORT_EVENT
	data := []byte{
		0, 0, 0, 0, // Placeholder for user ID
		0, 0, 11, 190, // Event ID (3006 for UntimelyAbort)
	}
	expected := &AsteroidsUntimelyAbortMessageDTO{}
